...
The simulation supports a physically traceable two-sided irradiation protocol for polarized-target material preparation. It directly reports electron/photon transport, dose, fluence, energy deposition, and heat load. It does not directly model radical species, radical survival, annealing behavior, ESR spectra, or final DNP polarization; those material-response quantities require experimental benchmarking.
...
## 2.8 Two-Sided Irradiation Protocol
...
## 3.1 Front and Back Depth-Dose Profiles
...
## 3.3 R-Z Dose Map and Target Coverage
...
## 3.4 Electron Fluence Through the Target
...
## 3.8 Supplemental Diagnostic Panel
...
## 4.1 Model Scope and Experimental Benchmarks
...
This manuscript was prepared by Samuel Takwirira for the UNH DNP Group / Jefferson Lab Target Group collaboration. The author gratefully acknowledges Dr. Karl Slifer for guidance during critique sessions that helped steer the work toward its intended direction. The work is motivated by polarized fixed-target material preparation and by the broader literature on irradiated ammonia targets for DNP [3-6].
